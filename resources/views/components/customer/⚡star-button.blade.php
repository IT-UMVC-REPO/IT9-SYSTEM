...
<div class="inline-flex">
    @if ($isStarred)
        <button
            ...
            class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[var(--brand-300)] bg-[var(--brand-100)] text-sm text-[var(--brand-700)] shadow-sm transition-all duration-200 hover:rotate-12 hover:bg-[var(--brand-50)] active:scale-75 disabled:cursor-not-allowed disabled:opacity-60 dark:border-[var(--brand-500)] dark:bg-zinc-800 dark:text-[var(--brand-200)]"
