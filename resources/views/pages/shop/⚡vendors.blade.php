        ...
        <div class="relative">
            ...
            >
                <section
                    ...
                    class="max-h-[calc(100%-2rem)] w-full max-w-md overflow-y-auto rounded-[1.75rem] border border-white/40 bg-white shadow-2xl dark:border-white/10 dark:bg-zinc-900"
                >
