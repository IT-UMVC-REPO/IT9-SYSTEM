...
return [
    ...
    */
    ...
    'app_id' => env('NATIVEPHP_APP_ID', 'com.sukimarket.app'),
    ...
    */
    ...
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'sukimarket'),
    ...
    */
    ...
    'server' => [
        ...
        'service_name' => env('NATIVEPHP_SERVICE_NAME', 'SukiMarket Mobile'),
